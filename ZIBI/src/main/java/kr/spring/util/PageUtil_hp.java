...
public class PageUtil_hp {
	 ...
	 * */
	public PageUtil_hp(int currentPage,int count, int rowCount) {
	...
	public PageUtil_hp(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {

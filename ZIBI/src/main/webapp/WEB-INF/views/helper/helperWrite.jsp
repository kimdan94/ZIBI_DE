...
<div class="page-main">
	...
	<form:form action="helperWrite" modelAttribute="helperVO" id="register_form"
		...
		<div>
            ...
            <form:select path="helper_select" id="helper_select"><!-- class 넣어야함 -->
            	<form:option value="" disabled="disabled" label="게시판"/>
       			<form:option value="1" label="헬프미" />
				<form:option value="2" label="헬프유" />
			</form:select>
        </div>
		<div>
            <form:label path="helper_category">카테고리</form:label>
            <form:select path="helper_category" id="helper_category"><!-- class 넣어야함 -->
            	<form:option value="" disabled="disabled" label="카테고리"/>
		...
		<div class="align-center">
			<form:button class="default-btn">글 등록</form:button>

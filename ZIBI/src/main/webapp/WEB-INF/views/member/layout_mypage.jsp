...
<body>
	...
	<div class="container page-width">
		<div class="row">
			<div class="col">
				<input type="button" class="btn mem-btn w-100" value="메인" onclick="location.href='${pageContext.request.contextPath}/member/mypageMain'" id="main_btn">
			</div>
			<div class="col">
				<input type="button" class="btn mem-btn w-100" value="거래 내역" onclick="location.href='${pageContext.request.contextPath}/member/mypageDeal'" id="deal_btn">
			</div>
			<div class="col">
				<input type="button" class="btn mem-btn w-100" value="활동 내역" onclick="location.href='${pageContext.request.contextPath}/member/mypageAct'" id="act_btn">
			</div>
			<div class="col">
				<input type="button" class="btn mem-btn w-100" value="팔로우 내역" onclick="location.href='${pageContext.request.contextPath}/member/mypageFollow'" id="follow_btn">
			</div>
		</div>

...
첫 프로젝트였던 세미 프로젝트를 진행하던 당시에는 CRUD 작업만으로도 벅찼고, <br>기한 내에 내가 맡은 부분을 완성하지 못하여 팀원들에게 피해를 주진 않을까 하는 걱정이 우선시 됐다. <br> 그래서 당시엔 수업에서 배운 내용을 기반으로 할 수 있는 마이페이지 부분을 맡았었다. <BR>
파이널 프로젝트에서는 CRUD는 물론이고 세미 때보다 좀 더 다양한 기능을 구현하고 싶었다.<br><br>
...
프로젝트 기간 내내 어려운 기능도 척척 해내고 빠른 속도로 진행하는 팀원들을 보며 작아지는 순간이 많았지만, 남들과 비교하기보다 이전의 나와 비교했을 땐 분명 성장했기 때문에 이번 프로젝트 경험을 바탕으로 앞으로도 어제의 나보다 더 성장할 수 있는 개발자가 되고 싶다는 다짐을 했다.</b>

<h4 align="left">2) 결정의 중요성</h4>

내가 맡은 게시판에 채팅 기능이 필요했고, 채팅 기능을 구현하기로 한 다른 팀원이 있었다. 프로젝트를 진행하는 도중 시간상 채팅 기능을 구현하기 어려울 것 같다는 다른 팀원의 의견에 고민에 빠졌다.<br>
채팅 기능 대신 넣을 수 있는 다른 방법들을 생각했지만, 내가 구현하려는 게시판 특성상 채팅이 가장 적합하다고 판단해 1:N 채팅을 구현하기로 했다.<br>
예정에 없던 일이라 기한 내에 끝낼 수 있을지가 걱정스러웠지만 수업에서 배운 1:N 채팅을 구현해 보기로 했다.<br>
채팅을 만들던 도중 강사님에게 질문을 했었는데, 그때 강사님께선 1:N 채팅이 아닌 1:1 채팅을 구현하라고 말씀해주셨다.<br>
...
이번 프로젝트에서 가장 아쉬운 점으로 꼽을 수 있는데, 채팅 기능을 완성하지 못한 가장 주요한 이유는 결정력 부족이었다.<br>
...
<b>어려운 문제에 있어 시도를 해본 경험은 좋았다고 생각하지만 시간이 한정되어 있을 땐 그 상황에 맞는 결정을 해야 좀 더 좋은 결과를 가져다줄 것이라는 생각을 했다.</b>
...
팀 프로젝트를 시작하면서 팀원들과 협업하는 과정을 겪게 되었고, 그 과정을 통해 문제를 함께 논의하는 것부터 해결하는 부분까지 무엇 하나 혼자서 이뤄나갈 수 있는 건 없다는 걸 느끼게 되었다.<br>

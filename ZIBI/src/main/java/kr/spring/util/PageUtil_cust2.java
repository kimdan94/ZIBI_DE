...
public class PageUtil_cust2 {
	 ...
	 * */
	public PageUtil_cust2(int currentPage,int count, int rowCount) {
	...
	public PageUtil_cust2(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
			...
			if(pageCount > 0) {
				...
				for (int i = startPage; i <= endPage; i++) {
					...
					if (i == currentPage) {
						...
						page.append("&nbsp;<a style='color:black;font-size:14px;text-decoration:none;' href='"+pageUrl+"?pageNum2=");
						page.append(i);
						page.append(sub_url+"'>");
						page.append(i);
						page.append("</a>");

...
public class PageUtil_second {
	 ...
	 * */
	public PageUtil_second(int currentPage,int count, int rowCount) {
	...
	public PageUtil_second(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {

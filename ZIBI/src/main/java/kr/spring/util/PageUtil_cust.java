...
public class PageUtil_cust {
	 ...
	 * */
	public PageUtil_cust(int currentPage,int count, int rowCount) {
	...
	public PageUtil_cust(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {

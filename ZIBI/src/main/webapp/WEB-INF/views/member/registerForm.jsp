		...
		<form:form action="register" id="register_member" modelAttribute="memberVO">
			<div class="row" style="height: 300px;">
				...
				<div class="wrap" id="emailAuthModal" style="display: none;">
					<div class="modal_box">
						<p>
							<img src="${pageContext.request.contextPath}/images/logo_mini.png" width="50px">
							입력하신 이메일로 전송된 인증코드 여섯자리를 입력해주세요
						</p>
						<input type="number" placeholder="인증코드 여섯자리 입력" id="userEmailAuth">
						<button class="btn mem-btn-green" onclick="javascript:closeModalAction()">닫기</button>
					</div>
